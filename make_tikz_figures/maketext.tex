...
\begin{tikzpicture}
    ...
    % \node[draw=blue, fill=blue, line width=0.5pt, minimum width=0.75cm, minimum height=0.075cm] (horizontal) at  (-2.5, 6.5) {};
    ...
    % \node[draw=red, fill=red, line width=1pt, minimum width=0.75cm, minimum height=0.075cm] (horizontal) at  (-4, 8) {};
    % % \node[draw=blue, fill=blue, line width=0.5pt, minimum width=0.075cm, minimum height=0.75cm] (vertical) at (-2.5, 6.5) {};

    % % Draw spin
    % \draw [->, line width = 3pt] (-2, 8 ) -- (-2, 9.5) node[right] {};

    \node[]  at (-2, 7.5) {\textbf{(a)}};

        \node[]  at (-3, 7.5) {\textbf{(b)}};

    \node[]  at (-5, 7.5) {\textbf{(c)}};

    \node[]  at (-6, 7.5) {\textbf{(d)}};
